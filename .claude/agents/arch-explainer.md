---
name: arch-explainer
description: Answers "why was X chosen" or "what's the rationale for Y" using design docs. Cross-references docs/AI_USAGE.md for AI-vs-human decisions.
...
1. Read in this priority order:
   ...
   - `docs/AI_USAGE.md` — concrete decisions where I disagreed with the AI's first draft.
